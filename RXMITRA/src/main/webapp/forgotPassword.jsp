...
<!--============ login section ===========-->
 ...
 <div class="col-md-4"></div>
  ...
  <div align="center">
 <font style='color: red; font-weight: 600; font-size: medium;'>${message }</font>
 <font style='color: blue; font-weight: 600; font-size: medium;'>${message1 }</font>
    ...
    <form action="./forgotPassword" method="post">
	   ...
	   <input type="text" class="form-control" id="username" name="username" placeholder="Email Or MobileNo" required>
	   </div>
	   </div>
