		...
		<div class="left-content">
			...
			<div class="inner-block">
				<div class="inbox">
					...
					<div  align="center">
			            <font style='color: blue; font-weight: 600; font-size: medium;'>${deleteInvoice}</font>
			              <font style='color: red; font-weight: 600; font-size: medium;'>${notDeleteInvoice}</font>
			              <font style='color: red; font-weight: 600; font-size: medium;'>${errorInvoice}</font>
			              <font style='color: red; font-weight: 600; font-size: medium;'>${emptyInvoiceNo}</font></div>
							...
							<div class="">
                                ...
                                <div colspan="12" style="padding: 5px;background: #5aa320;color:#fff;text-align: center;font-size: 20px;border-bottom: 2px solid #febf10;">
									...
									<div class="form-group col-md-4 col-sm-4">
										<label for="pincode">INVOICE NO :</label> <input type="text"
											class="form-control" name="invoiceNo" id="invoiceNo" value="${invoiceNo }"
											placeholder="Enter Your INVOICE NO" required/>
									</div>
