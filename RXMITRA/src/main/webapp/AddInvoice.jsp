<%@ page language="java" import="com.rxmitra.dao.*,com.rxmitra.bean.*,com.rxmitra.service.*,java.util.*" contentType="text/html; charset=ISO-8859-1" isErrorPage="true" pageEncoding="ISO-8859-1"%>
  ...
  <div class="panel panel-orange" style="padding:2px 13px;">
   ...
   <form  action="./processAddInvoice" method="post" enctype="multipart/form-data"> 
	...
	<div class="col-md-12" id="one">
        ...
        <input type="file" class="form-control" name="file" id="file" placeholder="Choose Required File" required/>
