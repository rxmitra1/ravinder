<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="com.rxmitra.bean.*" import="java.util.*"%>
							...
							<div class="for4">
									...
									<form action="./setSalesPrice?update=yes" method="post">
										...
										<div class="form-group col-md-3 col-sm-3">
											<label for="pincode">SKU ID :</label> <input type="text"
												...
												placeholder="Enter Your SKU ID" value="${skuid }" /> <input
										...
										<div class="form-group col-md-3 col-sm-3">
											<label for="pincode">PRODUCT NAME :</label> <input
												type="text" class="form-control" name="productName"
												id="productName" placeholder="Enter Your Product Name"
												value="${productName }" />
										</div>
								...
								<div class="col-lg-12" id="form7">
									<div align="center">
										...
										<font
											style='color: blue; font-weight: 600; font-size: medium;'>${ updateSuccess}</font>
									</div>
									<form action="./updateSetSalesBySkuid" method="get"
											...
											<c:forEach items="${VendorInvoiceList}"
												...
												<tr id="${VendorInvoiceList.addInvoiceId }row1">
													...
													<td data-title="Class" class="numeric" id="name_row1">
														${VendorInvoiceList.invoiceNo}</td>
													<td data-title="Year" class="numeric" id="country_row1">
														${VendorInvoiceList.manufacturer}</td>
													<td data-title="Institution" class="numeric" id="age_row1">
														${VendorInvoiceList.productName}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.weight}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.packageType}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.expiryDate}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.purchasePrice}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.discountPrice}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.actualPrice}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.mrp}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.salesDiscount}</td>
													<td data-title="Address" class="numeric" id="age1_row1">
														${VendorInvoiceList.sellingPrice}</td>

													<div class="col-md-12">
														<td data-title="" class="numeric">
															<div class="col-md-2" id="edit_button1">
																<input type="checkbox" id="s<%=i%>" class="myCheck"
																	name="checkProducts"
																	value="${VendorInvoiceList.addInvoiceId }"
																	onclick="edit_row('${VendorInvoiceList.addInvoiceId }')"
																	style="width: 18px; height: 18px;"> </input>
															</div>
												...
												<tr style="display: none;"
													id="${VendorInvoiceList.addInvoiceId }show">
													<div class="col-md-2">
														<td colspan=""><input type="text"
															class="form-control" name="productName" required
															value="${VendorInvoiceList.invoiceNo}" size="15"
															readonly="readonly" /> <input type="hidden"
															class="form-control" name="addInvoiceIds" required
															value="${VendorInvoiceList.addInvoiceId}" size="15" />
														</td>

														<td colspan=""><input type="text"
															class="form-control" name="manufacturer" required
															value="${VendorInvoiceList.manufacturer}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="productName" required
															value="${VendorInvoiceList.productName}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="weight" required
															value="${VendorInvoiceList.weight}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="packageType" required
															value="${VendorInvoiceList.packageType}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="expiryDate" required
															value="${VendorInvoiceList.expiryDate}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="purchasePrice" required
															value="${VendorInvoiceList.purchasePrice}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="discountPrice" required
															value="${VendorInvoiceList.discountPrice}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="actualPrice" required
															value="${VendorInvoiceList.actualPrice}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" name="mrp" required
															value="${VendorInvoiceList.mrp}" size="15"
															readonly="readonly" /></td>

														<td colspan=""><input type="text"
															class="form-control" id="salesDiscount1"
															name="salesDiscount" required
															value="${VendorInvoiceList.salesDiscount}" size="15" /></td>

														<td colspan=""><input type="text"
															class="form-control" id="sellingPrice1"
