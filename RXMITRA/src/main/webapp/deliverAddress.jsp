...
<!--======= search section =========-->	
 ...
 <!--======= end search section =========-->
  <!--======= search section =========-->
             ...
             <div align="center">
            <font style='color: red; font-weight: 600; font-size: medium;'>${deliverAddressFailure}</font>
             <font style='color: blue; font-weight: 600; font-size: medium;'>${deliverAddressSuccess}</font>
            </div>
 
  <form action="./addDeliverAddress" method="post">
   <div class="containe" style="margin-top: 21px;">
	<div class="row">
	<div class="col-lg-2"></div>
      ...
      <div class="col-lg-8 row">
        ...
        <div class="col-md-5">
        <lable class="up1">Deliver Address :</lable><br>
        <textarea class="up8" rows="4" name="deliverAddress"  id="address" value="${ deliverAddress.deliverAddress}" placeholder="Enter Deliver Address ........" 
        required="required"></textarea>
       
        </div>
        
        <div class="col-md-4">
        <lable class="up1">File Upload :</lable><br>
         <input type="file"  name="deliverAddressFile" id="myFile"  value="${ deliverAddress.deliverAddressFile}" class="form1">
        </div>
        
         <div class="col-md-2">
         <input type="submit" name="" class="btn btn-success" id="up0" value="Upload">
         </div>
