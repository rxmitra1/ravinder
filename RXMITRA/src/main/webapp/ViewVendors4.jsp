						...
						<div class="panel panel-orange" style="padding: 2px 13px;">
							<div class="">
									...
									<div class="col-md-12" id="one">
										<div class="form-group col-md-4 col-sm-4">
											<label for="pincode">VENDOR NAME</label> <input type="text"
												class="form-control" name="vendorname" id="vendorname" value="${ vendor.vendorName }"
								...
								<table class="table table-bordered">
									...
									<tr>
										<td><input type="radio" name="vendorid"
											value="${ vendor.vendorId }"
											onclick="location.href='SelectProductType?vid=${vendor.vendorId}&from=EU'" /></td>
