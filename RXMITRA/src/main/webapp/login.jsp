...
<body>
	...
	<div class="super_container">
		...
		<div class="row">
            ...
            <font style='color: blue; font-weight: 600; font-size: medium;'>${resetSuccess}</font>
				...
				<form  method="post" action="./userLogin">
					...
					<div class="row form-group">
						<div class="col-lg-12">
							<label>User Name</label> <input type="text" class="form-control"
								id="username" name="username" placeholder="Email Or MobileNo" required>
						</div>
					</div>
					...
					<div class="row form-group">
						<div class="col-lg-12">
							<label>Password</label> <input type="password"
								class="form-control" id="password" name="password" placeholder="Your Password"
								required>
						</div>
					</div>
					...
					<div class="row" style="float: right;">
						<p>
							<a href='./forgotPassword.jsp' id="one1">Forgot Password </a>
						</p>
					</div>
					<div class="clearfix"></div>
					<div class="row">
						<p style="font-size: 17px;">
							Don't have account in Rxmitra? <a href="register.jsp" id="one2">Sign
								Up</a>
						</p>
					</div>
				</form>
