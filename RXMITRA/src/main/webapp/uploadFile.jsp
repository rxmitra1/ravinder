   ...
   <div class="containe" style="margin-top: 21px;">
	...
	<div class="col-lg-2"></div>
      ...
      <div class="col-lg-8 row">
        ...
        <textarea class="up8" rows="4" name="deliverAddress"  id="address" placeholder="Enter Deliver Address ........" 
        ...
        <lable class="up1">File Upload :</lable><br>
         <input type="file"  name="deliverAddressFile" id="myFile" class="form1">
        </div>
