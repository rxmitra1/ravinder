...
public class AddInvoiceDAO {
	...
	public List<AddInvoice> viewVendorInvoiceDetails(Integer invoiceNo, int pageid, int limit) {
		String query = "from com.rxmitra.bean.AddInvoice where invoiceNo='" + invoiceNo + "'";
	...
	/*
	 * public String deleteInvoiceBySkuid(String invoiceSkuid, String
	 * productName, String manufacturer) { String message = ""; String query =
	 * "delete com.rxmitra.bean.AddInvoice i where (i.skuid='" + invoiceSkuid +
	 * "' or i.productName='" + productName + "' or i.manufacturer='" +
	 * manufacturer + "')";
	 * 
	 * Query createQuery =
	...
	public List<AddInvoice> viewVendorInvoiceBySkuid1(String userId,String invoiceSkuid, String productName, String manufacturer,
			Integer pageid, Integer limit) {
		String query = "from com.rxmitra.bean.AddInvoice i where (i.skuid='" + invoiceSkuid + "' or i.productName='"
	...
	public List<AddInvoice> setSalesPrice(String userId,String skuid,String manufacturer,String productName) {
		String query = "from com.rxmitra.bean.AddInvoice ai where (ai.skuid='" + skuid + "' or  ai.manufacturer='" + manufacturer + "' or  ai.productName='" + productName + "') and ai.userId='"+userId+"'";
	...
	public List<AddInvoice> viewSetSalesPriceAll() {
		String query = "from com.rxmitra.bean.AddInvoice";
